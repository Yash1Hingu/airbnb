            ...
            <div className="mt-2">
                ...
                <div className="grid grid-cols-3">
                    <label className="placepage_checkbox">
                        <input type="checkbox" name="wifi" onChange={handleCbTick} />
                        <span>
                    ...
                    <label className="placepage_checkbox">
                        <input type="checkbox" name="free parking spot" onChange={handleCbTick} />
                        <span>
                    ...
                    <label className="placepage_checkbox">
                        <input type="checkbox" name="TV" onChange={handleCbTick} />
                        <span>
                    ...
                    <label className="placepage_checkbox">
                        <input type="checkbox" name="Pets" onChange={handleCbTick} />
                        <span>
                    ...
                    <label className="placepage_checkbox">
                        <input type="checkbox" name="Private Entrance" onChange={handleCbTick} />
                        <span>
