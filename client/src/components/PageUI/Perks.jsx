        ...
        <>
            <div className="mt-2">
                ...
                <div className="grid grid-cols-3">
                    ...
                    <label className="placepage_checkbox">
                        <input type="checkbox" name="free parking spot" onChange={handleCbTick} checked={selected.includes('free parking spot')}/>
                        <span>
                    ...
                    <label className="placepage_checkbox">
                        <input type="checkbox" name="TV" onChange={handleCbTick} checked={selected.includes('TV')}/>
                        <span>
                    ...
                    <label className="placepage_checkbox">
                        <input type="checkbox" name="Pets" onChange={handleCbTick} checked={selected.includes('Pets')}/>
                        <span>
                    ...
                    <label className="placepage_checkbox">
                        <input type="checkbox" name="Private Entrance" onChange={handleCbTick} checked={selected.includes('Private Entrance')}/>
                        <span>
